...
class SpellingDictionaryCollection {
    ...
    suggest(word, numSuggestions, compoundMethod = SpellingDictionary_1.CompoundWordsMethod.SEPARATE_WORDS) {
        word = word.toLowerCase();
        compoundMethod = this.options.useCompounds ? SpellingDictionary_1.CompoundWordsMethod.JOIN_WORDS : compoundMethod;
        const collector = this.genSuggestions(SpellingDictionary_1.suggestionCollector(word, numSuggestions, word => !this.wordsToFlag.has(word)), compoundMethod);
