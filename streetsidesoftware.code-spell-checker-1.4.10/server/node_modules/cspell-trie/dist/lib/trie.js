...
class Trie {
     ...
     */
    suggest(text, maxNumSuggestions, compoundMethod) {
     ...
     */
    suggestWithCost(text, maxNumSuggestions, compoundMethod) {
        return suggest_1.suggest(this.root, text, maxNumSuggestions, compoundMethod);
    }
    /**
