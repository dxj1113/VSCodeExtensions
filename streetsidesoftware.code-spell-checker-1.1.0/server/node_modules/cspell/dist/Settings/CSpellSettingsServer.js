...
function readSettings(filename, defaultValues = defaultSettings) {
    ...
    const languageSettings = (settings.languageSettings || [])
        .map(langSetting => (__assign({}, langSetting, { dictionaryDefinitions: DictionarySettings_1.normalizePathForDictDefs(langSetting.dictionaryDefinitions || [], pathToSettings) })));
