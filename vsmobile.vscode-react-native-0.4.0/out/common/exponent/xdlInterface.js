...
function getPackage() {
    ...
    xdlPackage = commandExecutor.spawnWithProgress(hostPlatform_1.HostPlatform.getNpmCliCommand("npm"), ["install", EXPO_DEPS.join(" "), "--verbose"], { verbosity: commandExecutor_1.CommandVerbosity.PROGRESS,
