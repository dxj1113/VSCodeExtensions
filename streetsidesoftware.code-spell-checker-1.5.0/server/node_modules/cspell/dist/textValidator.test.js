...
describe('Validate textValidator functions', () => {
    ...
    it('tests trailing s, ed, ing, etc. are attached to the words', () => {
        const dictEmpty = SpellingDictionary_2.createSpellingDictionary([], 'empty');
    ...
    it('tests maxDuplicateProblems', () => {
        const dict = SpellingDictionary_2.createSpellingDictionary([], 'empty');
        ...
        const dict2 = SpellingDictionary_2.createSpellingDictionary(words, 'test');
...
function getSpellingDictionaryCollection() {
    const dicts = [
        SpellingDictionary_2.createSpellingDictionary(colors, 'colors'),
        SpellingDictionary_2.createSpellingDictionary(fruit, 'fruit'),
        SpellingDictionary_2.createSpellingDictionary(animals, 'animals'),
        SpellingDictionary_2.createSpellingDictionary(insects, 'insects'),
        SpellingDictionary_2.createSpellingDictionary(words, 'words', { repMap: [['’', "'"]] }),
    ];
