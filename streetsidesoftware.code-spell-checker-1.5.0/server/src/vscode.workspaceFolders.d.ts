...
export declare type GetConfigurationParams = string | vscode.Proposed.ConfigurationItem | vscode.Proposed.ConfigurationItem[];
...
export declare function getConfiguration(connection: Connection, item: vscode.Proposed.ConfigurationItem): Thenable<any>;
export declare function getConfiguration(connection: Connection, items: vscode.Proposed.ConfigurationItem[]): Thenable<any[]>;
