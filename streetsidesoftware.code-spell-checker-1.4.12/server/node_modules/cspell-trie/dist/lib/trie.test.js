...
describe('Validate Trie Class', () => {
    ...
    it('Test compound words', () => {
        ...
        chai_1.expect(trie.has('awalk', true)).to.be.false;
        chai_1.expect(trie.has('jayjay', true)).to.be.true;
        chai_1.expect(trie.has('jayjay', 4)).to.be.false;
        chai_1.expect(trie.has('jayi', 3)).to.be.false;
        chai_1.expect(trie.has('toto', true)).to.be.false;
        chai_1.expect(trie.has('toto', 2)).to.be.true;
        chai_1.expect(trie.has('toto', 1)).to.be.true;
        chai_1.expect(trie.has('iif', 1)).to.be.true;
        chai_1.expect(trie.has('uplift', true)).to.be.false;
        chai_1.expect(trie.has('endless', true)).to.be.true;
