...
//        vscode.window.activeTextEditor.edit((edit)=>{ edit.replace(vscode.window.activeTextEditor.selection, txt); });
//        vscode.commands.executeCommand("editor.action.clipboardCopyAction")
//                       .then(success => {}, error => {console.error(error)});

//        vscode.window.setStatusBarMessage('Html copied to clipboard!', 3000);
