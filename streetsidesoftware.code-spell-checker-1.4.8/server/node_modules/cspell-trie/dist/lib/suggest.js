...
function suggest(root, word, maxNumSuggestions = defaultMaxNumberSuggestions, compoundMethod = walker_1.CompoundWordsMethod.NONE) {
...
function* genCompoundableSuggestions(root, word, compoundMethod) {
    ...
    const specialDiscounts = {
        [walker_1.WORD_SEPARATOR]: insertSpaceDiscount,
        [walker_1.JOIN_SEPARATOR]: insertSpaceDiscount,
    };
