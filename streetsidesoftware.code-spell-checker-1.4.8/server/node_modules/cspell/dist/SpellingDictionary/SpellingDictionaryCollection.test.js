...
describe('Verify using multiple dictionaries', () => {
    ...
    it('checks for suggestions from mixed sources', () => {
        return Promise.all([
            SpellingDictionary_1.createSpellingDictionaryRx(Rx.Observable.from(wordsA), 'wordsA'),
            SpellingDictionary_1.createSpellingDictionary(wordsB, 'wordsB'),
            SpellingDictionary_1.createSpellingDictionary(wordsC, 'wordsC'),
        ])
            .then(dicts => {
    ...
    it('creates using createCollectionP', () => {
        const dicts = [
            Promise.resolve(SpellingDictionary_1.createSpellingDictionary(wordsA, 'wordsA')),
            Promise.resolve(SpellingDictionary_1.createSpellingDictionary(wordsB, 'wordsB')),
            Promise.resolve(SpellingDictionary_1.createSpellingDictionary(wordsC, 'wordsC')),
        ];
