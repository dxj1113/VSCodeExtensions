...
function activate(context, client) {
    ...
    function setLocal(local, enable, isGlobal) {
        if (enable) {
    ...
    function genSetLocal(code, enable, isGlobal) {
        return genCommandLink(exports.commandSetLocal, [code, enable, isGlobal]);
    }
    ...
    function composeLocalInfo(settingsFromServer) {
        ...
        availableLocals.concat(localsFromServer, globalLocals, workspaceLocals)
    ...
    context.subscriptions.push(subOnDidChangeEditor, subOnDidChangeDoc, vscode.commands.registerCommand(exports.commandDisplayCSpellInfo, displayCSpellInfo), vscode.commands.registerCommand(exports.commandEnableLanguage, enableLanguage), vscode.commands.registerCommand(exports.commandDisableLanguage, disableLanguage), vscode.commands.registerCommand(exports.commandSetLocal, setLocal), vscode.commands.registerCommand(exports.commandSelectInfoTab, selectInfoTab), registration, makeDisposable(subOnDidChangeTextDocument));
}
