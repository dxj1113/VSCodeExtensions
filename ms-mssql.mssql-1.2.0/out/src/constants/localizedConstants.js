...
exports.loadLocalizedConstants = (locale) => {
    ...
    exports.msgPromptRetryConnectionDifferentCredentials = localize(74, null);
    exports.retryLabel = localize(75, null);
    exports.msgConnecting = localize(76, null);
    exports.msgConnectedServerInfo = localize(77, null);
    exports.msgConnectionFailed = localize(78, null);
    exports.msgChangingDatabase = localize(79, null);
    exports.msgChangedDatabase = localize(80, null);
    exports.msgDisconnected = localize(81, null);
    exports.msgErrorReadingConfigFile = localize(82, null);
    exports.titleResultsPane = localize(83, null);
    exports.macOpenSslErrorMessage = localize(84, null);
    exports.macOpenSslHelpButton = localize(85, null);
    exports.macSierraRequiredErrorMessage = localize(86, null);
    exports.gettingDefinitionMessage = localize(87, null);
    exports.definitionRequestedStatus = localize(88, null);
    exports.definitionRequestCompletedStatus = localize(89, null);
    exports.updatingIntelliSenseStatus = localize(90, null);
    exports.intelliSenseUpdatedStatus = localize(91, null);
    exports.testLocalizationConstant = localize(92, null);
    exports.disconnectOptionLabel = localize(93, null);
    exports.disconnectOptionDescription = localize(94, null);
    exports.disconnectConfirmationMsg = localize(95, null);
    exports.elapsedBatchTime = localize(96, null);
    exports.noActiveEditorMsg = localize(97, null);
    exports.maximizeLabel = localize(98, null);
    exports.restoreLabel = localize(99, null);
    exports.saveCSVLabel = localize(100, null);
    exports.saveJSONLabel = localize(101, null);
    exports.saveExcelLabel = localize(102, null);
    exports.resultPaneLabel = localize(103, null);
    exports.selectAll = localize(104, null);
    exports.copyLabel = localize(105, null);
    exports.copyWithHeadersLabel = localize(106, null);
    exports.messagePaneLabel = localize(107, null);
    exports.lineSelectorFormatted = localize(108, null);
    exports.elapsedTimeLabel = localize(109, null);
    exports.msgCannotSaveMultipleSelections = localize(110, null);
    exports.mssqlProviderName = localize(111, null);
    exports.noneProviderName = localize(112, null);
    exports.chooseSqlLang = localize(113, null);
    exports.flavorChooseLanguage = localize(114, null);
    exports.flavorDescriptionMssql = localize(115, null);
    exports.flavorDescriptionNone = localize(116, null);
};
