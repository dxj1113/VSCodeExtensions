...
const latexlog_1 = require("./providers/latexlog");
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        context.subscriptions.push(vscode.window.registerTreeDataProvider('latex-outline', new outline_1.SectionNodeProvider(extension)));
        lintRootFileIfEnabled(extension);
        obsoleteConfigCheck();
...
class Extension {
    constructor() {
        ...
        this.logProvider = new latexlog_1.LaTeXLogProvider(this);
